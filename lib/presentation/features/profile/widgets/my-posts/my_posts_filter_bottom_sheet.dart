...
class MyPostsFilterBottomSheet extends StatefulWidget {
  ...
  const MyPostsFilterBottomSheet({
    super.key,
  ...
  @override
  State<MyPostsFilterBottomSheet> createState() =>
      _MyPostsFilterBottomSheetState();
}

class _MyPostsFilterBottomSheetState extends State<MyPostsFilterBottomSheet>
