...
class PostsFilterBottomSheet extends StatefulWidget {
  ...
  @override
  State<PostsFilterBottomSheet> createState() => _PostsFilterBottomSheetState();
}

class _PostsFilterBottomSheetState extends State<PostsFilterBottomSheet>
          ...
          PostType.values
              .map(
                (type) => _buildFilterChip(
                  label: type.label,
                  icon: type.icon,
                  isSelected: _tempSelectedType == type,
                  onSelected: () {
                    setState(() {
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Row(
            children: [
              // Apply Button - Now smaller (flex: 1)
              Expanded(
                flex: 1,
