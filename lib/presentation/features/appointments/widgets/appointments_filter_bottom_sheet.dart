...
class AppointmentsFilterBottomSheet extends StatefulWidget {
  ...
  final Function(SortOrder) onApplyFilters;
  ...
  @override
  State<AppointmentsFilterBottomSheet> createState() =>
      _AppointmentsFilterBottomSheetState();
}
...
class _AppointmentsFilterBottomSheetState
  ...
  void _applyFilters() {
    widget.onApplyFilters(_tempSelectedSort);
    _closeSheet();
  }

  void _resetFilters() {
    setState(() {
      _tempSelectedSort = SortOrder.startTimeDesc; // Default to startTimeDesc
    });
  }
  ...
  bool get _hasActiveFilters {
    return _tempSelectedSort !=
        SortOrder.startTimeDesc; // Changed default to startTimeDesc
  }
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Sắp xếp cuộc hẹn theo thời gian',
  ...
  Widget _buildSortFilters() {
    // Only show startTime-related sort options
    final startTimeSortOptions = [
