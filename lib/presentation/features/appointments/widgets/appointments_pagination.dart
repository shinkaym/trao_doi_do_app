...
class AppointmentsPaginationButton extends StatelessWidget {
  final IconData icon;
  final bool enabled;
  ...
  const AppointmentsPaginationButton({
    super.key,
    required this.icon,
...
class AppointmentsPageButton extends StatelessWidget {
  final int page;
  final bool isActive;
  final bool isTablet;
  final ColorScheme colorScheme;
