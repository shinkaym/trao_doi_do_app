...
class ItemWarehousesTopActionBar extends StatelessWidget {
  ...
  const ItemWarehousesTopActionBar({
    super.key,
...
class ItemWarehousesFilterButton extends StatelessWidget {
  final VoidCallback onPressed;
  final bool isTablet;
  final ColorScheme colorScheme;
  final bool hasActiveFilters;

  const ItemWarehousesFilterButton({
    super.key,
